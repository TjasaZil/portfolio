<template>
  <section
    class="flex flex-col mt-16 rounded-lg w-11/12 mx-auto h-auto p-6 max-w-7xl"
  >
    <hr
      class="w-full max-w-7xl border border-solid border-neutral-300 mx-auto rounded-lg"
    />
    <div
